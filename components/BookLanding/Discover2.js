                    ...
                    <div className="row h-100 justify-content-center align-items-center">
                        <div className="col-lg-8 col-md-12">
                            <div className="discover-content">
                                ...
                                <p>Dzięki SEKRETOM ROZWOJU OSOBISTEGO… </p>
                                ...
                                <ul>
                                    ...
                                    <li><i className="icofont-check"></i> Dowiesz się jak wyznaczać cele, by spełniać swoje najgłębsze pragnienia</li>
                                    <li><i className="icofont-check"></i> Uświadomisz sobie moc samodyscypliny</li>
