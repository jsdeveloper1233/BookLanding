    ...
    <section className="pricing-area ptb-100 bg-gray" id="ceny">
      <div className="container" id="pakiety">
        <div className="section-title">
          ...
          <p>
            Przygotowałem dla Ciebie 2 pakiety. Zamawiając Pakiet VIP otrzymasz
            również sesje mentorskie ze mną, narzędzie "Radykalna prawda w
            związu" oraz eBook "Dziecko - jak uzyskać jego zaufanie".
          </p>
        </div>
            ...
            <div className="pricingTable">
              ...
              <div className="pricing-content">
                <ul>
                  ...
                  <li className="active">Dzień 3: moc intencji i Joganidra</li>
                  <li className="active">Dzień 4: relacje i związki</li>
                  <li className="active">
                    Dzień 5: neuropsychologia i rodzaje medytacji
                  </li>
                  <li className="active">
                    Dzień 6: powstanie patriarchatu i jego wpływ na nasze życie
                  </li>
          ...
          <div className="col-lg-6 col-md-6 offset-lg-0 offset-md-3">
            <div className="pricingTable">
              ...
              <div className="pricing-content">
                ...
                <p>
                  <strong>
                    Kupując pakiet rozszerzony otrzymasz również narzędzia o
                    łącznej wartości 750 zł
                  </strong>
                </p>
                <ul>
                  <li className="active">
                    2 sesje mentorskie z Sergio S Dorje
                  </li>
                  <li className="active">
                    Radykalna prawda w związku - eBook z ćwiczeniami
                  </li>
                  <li className="active">
                    Dziecko - jak uzyskać jego zaufanie - eBook
                  </li>
                </ul>
              </div>
              <Link href="">
                <button className="btn btn-primary" disabled={disable} className={`btn btn-primary order-btn ${
                    disable ? "btn-disabled" : ""
                  }`}>
                  Dołączam!
                </button>
